...
var Tabs = function (_React$PureComponent) {
    ...
    function Tabs() {
        ...
        _this.renderTabBar = function (props) {
            ...
            if (typeof _this.props.underLineWidth !== 'undefined') {
                props.underLineWidth = _this.props.underLineWidth;
            }
            if (typeof _this.props.tabBarActiveTextWeight !== 'undefined') {
              props.tabBarActiveTextWeight = _this.props.tabBarActiveTextWeight;
            }
