...
static RCTPromiseResolveBlock _wxpay_resolve;
static RCTPromiseRejectBlock _wxpay_reject;
...
+(instancetype)sharedManager {
    ...
    static RCTWeChat *instance;
    dispatch_once(&onceToken, ^{
        instance = [[RCTWeChat alloc] init];
    });
    return instance;
}
...
RCT_EXPORT_METHOD(isWXAppInstalled:(RCTPromiseResolveBlock) resolver rejecter:(RCTPromiseRejectBlock)rejecter) {
...
RCT_EXPORT_METHOD(sendAuthRequest:(NSString *)scope
    ...
    _wxpay_resolve = resolver;
    _wxpay_reject = rejecter;
                  ...
                  resolver:(RCTPromiseResolveBlock) resolver rejecter:(RCTPromiseRejectBlock)rejecter)
{
    ...
    req.sign                = data[@"sign"];
    BOOL success = [WXApi sendReq:req];
    //    resolver(@[success ? [NSNull null] : INVOKE_FAILED]);
}
