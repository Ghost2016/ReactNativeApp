...
var DatePickerView = function (_React$Component) {
    ...
    (0, _createClass3['default'])(DatePickerView, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(_DatePicker2['default'], (0, _extends3['default'])({}, props, { locale: locale, date: props.value, onDateChange: props.onChange, onValueChange: props.onValueChange, onScrollChange: props.onScrollChange, style: props.style || {}}));
        }
    }]);
