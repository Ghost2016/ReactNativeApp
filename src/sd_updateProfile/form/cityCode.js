export default class cityCode {
      ...
      Province: [
        ...
        },
        {
          ...
          City: [
            ...
            { id: "0728", name: "仙桃市", Area: [] },
            { id: "1719", name: "神农架林区", Area: [] },
            {
              id: "1728",
              name: "天门市",
              Area: []
        ...
        },
        {
          ...
          name: "海南省",
          City: [
            { id: "0801", name: "保亭黎族苗族自治县", Area: [] },
            { id: "0802", name: "白沙黎族自治县", Area: [] },
            {
              id: "0803",
              name: "昌江黎族自治县",
              Area: []
            },
            { id: "0804", name: "澄迈县", Area: [] },
            { id: "0805", name: "儋州市", Area: [] },
            {
              id: "0806",
              name: "定安县",
              Area: []
            },
            { id: "0807", name: "东方市", Area: [] },
            { id: "0809", name: "陵水黎族自治县", Area: [] },
            {
              id: "0898",
              name: "海口市",
              Area: [
            ...
            { id: "1892", name: "屯昌县", Area: [] },
            { id: "1893", name: "文昌市", Area: [] },
            {
              id: "1894",
              name: "琼海市",
              Area: []
            },
            { id: "1896", name: "临高县", Area: [] },
            { id: "1897", name: "五指山市", Area: [] },
            {
              id: "1898",
              name: "万宁市",
              Area: []
            },
            { id: "1899", name: "琼中黎族苗族自治县", Area: [] },
            { id: "2802", name: "乐东黎族自治县", Area: [] },
            {
              id: "2898",
              name: "三沙市",
              Area: [
        ...
        },
        {
          ...
          City: [
            ...
            { id: "1906", name: "北屯市", Area: [] },
            { id: "1909", name: "双河市", Area: [] },
            {
              id: "1994",
              name: "五家渠市",
              Area: []
            },
            { id: "1996", name: "铁门关市", Area: [] },
            { id: "1997", name: "阿拉尔市", Area: [] },
            {
              id: "1998",
              name: "图木舒克市",
              Area: []
      ...
      for (let i = 0; i < this.CityZoneCode.China.Province.length; i++) {
        if (this.CityZoneCode.China.Province[i].id == provinceId) {
          ...
          if (cityId) {
            for (
              let j = 0;
              j < this.CityZoneCode.China.Province[i].City.length;
              j++
            ) {
              if (this.CityZoneCode.China.Province[i].City[j].id == cityId) {
                ...
                if (areaId) {
                  for (
                    let k = 0;
                    k < this.CityZoneCode.China.Province[i].City[j].Area.length;
                    k++
                  ) {
                    if (
                      this.CityZoneCode.China.Province[i].City[j].Area[k].id ==
                      areaId
                    ) {
                      areaIndex = k;
                    }
  ...
  static cityId2name(provinceId, cityId, areaId) {
    ...
    let province =
      cityCode.CityZoneCode.China.Province[addressIndex.provinceIndex].name;
    let city =
      cityCode.CityZoneCode.China.Province[addressIndex.provinceIndex].City[
        addressIndex.cityIndex
      ].name;
    let area = "";
    if (
      cityCode.CityZoneCode.China.Province[addressIndex.provinceIndex].City[
        addressIndex.cityIndex
      ].Area[addressIndex.areaIndex]
    ) {
      area =
        cityCode.CityZoneCode.China.Province[addressIndex.provinceIndex].City[
          addressIndex.cityIndex
        ].Area[addressIndex.areaIndex].name;
    }
