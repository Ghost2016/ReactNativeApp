...
class SwitchIdLightBoxFull extends React.PureComponent {
  constructor(props) {
    super(props);
  }
  static contextTypes = {
...
class EducationItem extends React.PureComponent {
    render() {
      ...
      return (
        <SDTouchOpacity style={{height: CSS.pixel(184), borderBottomColor: '#eee', borderBottomWidth: bordered ? 1 : 0}} onPress={() => {
            if (!isDefault) {
