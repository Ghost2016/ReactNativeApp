...
import LoginMainScreenSms from './LoginMainScreenSms'
...
class LoginMainScreen extends React.Component {
  ...
  onPressLoginSms() {
    ...
    //跳转到输入验证码
    this.context.navigator.push(
      navScreen("PushScreen", "输入验证码", {
        passProps: {
          screen: () => <LoginMainScreenSms userPhone={this.state.userPhone} />,
          fullScreen: true,
          //noScrollView: true,
          //backgroundColor: '#fff',
          /* header: {
  ...
  onPressLoginWithPassword() {
    ...
    this.context.navigator.push(
      navScreen("PushScreen", "登录", {
        passProps: {
          screen: () => <LoginMainScreenWithPassword />,
          fullScreen: true,
          //noScrollView: true,
          //backgroundColor: '#fff',
          /* header: {
    ...
    return (
      <ScrollView keyboardShouldPersistTaps="handled" style={{
        ...
        >
          ...
          <Touchable
              onPress={this.onPressLoginWithPassword.bind(this)}
